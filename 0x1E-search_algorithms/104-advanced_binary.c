...
/**
 * bin_recursive - search for value in sorted int array
 * using Binary search algorithm
 * @array: pointer to int array
 * @value: value to find
 * @first: first index of subarray
 * @last: last index of subarray
 * Return: index of first match or return -1 if not found
 */
...
/**
 * advanced_binary - search for value in sorted int array
 * using Binary search algorithm
 * @array: pointer to int array
 * @size: size of array
